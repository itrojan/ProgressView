...
public class ProgressView {
    ...
    private ProgressViewMaskType mProgressViewMaskType;

    public enum ProgressViewMaskType {
        None,  // 允许遮罩下面控件点击
        Clear,     // 不允许遮罩下面控件点击
    ...
    public void show() {
        setMaskType(ProgressViewMaskType.Black);
        mSharedView.show();
        svShow();
    }

    public void showWithMaskType(ProgressViewMaskType maskType) {
        //判断maskType
    ...
    public void showWithStatus(String string, ProgressViewMaskType maskType) {
        setMaskType(maskType);
        mSharedView.showWithStatus(string);
        svShow();
    }
    ...
    public void showInfoWithStatus(String string, ProgressViewMaskType maskType) {
        setMaskType(maskType);
        mSharedView.showInfoWithStatus(string);
        svShow();
        scheduleDismiss();
    ...
    public void showSuccessWithStatus(String string, ProgressViewMaskType maskType) {
        setMaskType(maskType);
        mSharedView.showSuccessWithStatus(string);
        svShow();
        scheduleDismiss();
    ...
    public void showErrorWithStatus(String string, ProgressViewMaskType maskType) {
        setMaskType(maskType);
        mSharedView.showErrorWithStatus(string);
        svShow();
        scheduleDismiss();
    ...
    public void showWithProgress(String string, ProgressViewMaskType maskType) {
        setMaskType(maskType);
    ...
    private void setMaskType(ProgressViewMaskType maskType) {
        mProgressViewMaskType = maskType;
        switch (mProgressViewMaskType) {
            case None:
